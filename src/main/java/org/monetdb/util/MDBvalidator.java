...
// old	{"sessions", "\"user\", login, active", null},	// sessions has changed in Jun2020 (11.37.7), pkey was previously "user", login, active
	...
	//	{"types WHERE schema_id <> 0 AND ", "schema_id", "id", "schemas", null},	// types with schema_id = 0 should no longer exist
		...
		{"users", "optimizer", "name", "optimizers", "45"},
		{"users", "default_role", "id", "auths", "45"},
		{"db_user_info", "name", "name", "auths", null},
		{"db_user_info", "default_schema", "id", "schemas", null},
		{"db_user_info", "optimizer", "name", "optimizers", "45"},
		{"db_user_info", "default_role", "id", "auths", "45"},
...
// not a fk:	{"queue", "\"username\"", "name", "users", null},	// as queue contains a historical list, the user may have been removed in the meantime, so not a real persistent fk
	...
	private static final String[][] sys_notnull = {
		...
		{"db_user_info", "schema_path", "45"},	// 6 new sys.db_user_info columns as of Sep2022 release (11.45)
		{"db_user_info", "max_memory", "45"},
		{"db_user_info", "max_workers", "45"},
		{"db_user_info", "optimizer", "45"},
		{"db_user_info", "default_role", "45"},
		{"db_user_info", "password", "45"},
		...
		{"users", "schema_path", "45"},	// 5 new sys.users columns as of Sep2022 release (11.45)
		{"users", "max_memory", "45"},
		{"users", "max_workers", "45"},
		{"users", "optimizer", "45"},
		{"users", "default_role", "45"},
